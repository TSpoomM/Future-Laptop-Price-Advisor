...
class HomePage:
    ...
    def init_component(self):
        ...
        title_label = ttk.Label(self.frame, text="Welcome to Future Laptop Price Advisor", font=("Helvetica", 18, "bold"))
        title_label.grid(row=0, column=0, columnspan=2, pady=20)

        # Add buttons with custom styling
        search_filter_button = ttk.Button(self.frame, text="Search and Filter", command=self.go_to_filter_page, style="TButton")
        search_filter_button.grid(row=1, column=0, padx=10, pady=10, sticky="ew")

        comparison_button = ttk.Button(self.frame, text="Comparison Tool", command=self.go_to_comparison_page, style="TButton")
        ...
        visualization_button = ttk.Button(self.frame, text="Statistics", command=self.go_to_visualization_page, style="TButton")
